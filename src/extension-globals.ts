...
export const COMMAND_SCDF_STREAMS_WEBVIEW_OPEN: string = 'vscode-spring-cloud-dataflow.streams.webviewopen';
...
export const WEBVIEW_STREAMS_VIEWTYPE = 'scdfs.preview';
